...
import shop.dao.ConnectionUtils;
import shop.dto.users.UserDTO;

public class UserDAO implements QueryConstants{
	public UserDTO read(UserDTO userDTO) throws ClassNotFoundException, SQLException, NamingException {
		Connection con = null;
		...
		try {
			...
			if(rs.next()) {
				...
				userObject.setMessage("Invalid UserName and Password");
			}
		}
		finally {
			if(rs!=null) {
